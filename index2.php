...
<html lang="en">
  <head>
    ...
    <title>Unsupervise</title>
    <meta name="Keywords" content=". Опытный, Элитный, VIP, Портной, Татой, Τατόι, на, выезд, Москва" />
    <meta name="Description" content="Unsupervise. Татой" -->
    <meta name="author" content="Unsupervise Τατόι">
  ...
  <body>
    ...
    <div id="maincenter">
        <div id="menu">
            <a href="/about.html">About</a> &emsp; <a href="/contact.html">Contacts</a>
        </div>
    </div>

        <div class="hero">

        <!-- блок частиц и появляющихся заголовков -->
          <!-- блок частиц -->
          <div id="container-p5"></div>

          <!-- блок появляющихся заголовков -->
          <div class="hero-content">
            <div id="example" style=" display: none; ">
                <h1><span>Unsupervise</span></h1>
                <h3><span class="highlight">8 (926) 931 93 22</span></h3>
            </div> 
          </div>
   ...
   <!--  <script src='https://cdnjs.cloudflare.com/ajax/libs/p5.js/0.6.0/p5.min.js'></script>
    ...
    <!-- для частиц и появления наплыва -->
    <script type="text/javascript" src='/js/p5.min.js'></script>
    <script type="text/javascript" src='/js/jquery.min.js'></script>
    <script type="text/javascript" src='/js/TweenMax.min.js'></script>
    <!-- скрипт частиц --> 
    <script type="text/javascript" src='/js/quarks.js'></script>
    <!-- скрипт появления наплыва -->
